...
@Component({
  selector: 'app-vandanamalik',
  templateUrl: './vandanamalik.component.html',
  styleUrls: ['./vandanamalik.component.scss']
})
export class VandanamalikComponent implements OnInit {
  public listseo:any;
