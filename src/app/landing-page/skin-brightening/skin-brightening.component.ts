...
@Component({
  selector: 'app-skin-brightening',
  templateUrl: './skin-brightening.component.html',
  styleUrls: ['./skin-brightening.component.scss']
})
export class SkinBrighteningComponent implements   OnInit {
